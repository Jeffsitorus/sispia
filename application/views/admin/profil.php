    ...
    <div class="container-fluid d-flex align-items-center">
      <div class="row">
        <div class="col-lg-12 col-md-12">
          ...
          <a href="<?= site_url('admin'); ?>" class="btn btn-neutral"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
          <a href="<?= site_url('admin/edit_profil'); ?>" class="btn btn-neutral"><i class="fas fa-edit"></i> Edit Profil</a>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="card card-profile">
          ...
          <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
            <div class="d-flex justify-content-between">
              <a href="#" class="btn btn-sm btn-info  mr-4 "><?php if($user['role_id'] == 1) { echo "Admin"; } ?></a>
              <a href="#" class="btn btn-sm btn-default float-right">SISPIA</a>
            </div>
          </div>
