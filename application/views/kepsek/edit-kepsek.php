  ...
  <div class="container-fluid mt--6">
    <div class="row">
      <div class="col-xl-12">
        ...
        <div class="card">
          <div class="card-body">
            <form action="<?= site_url('kepsek/edit/' . $kepsek['nip']); ?>" method="post">
              <div class="row">
                <div class="col-xl-6">
                  <div class="form-group">
                    <label for="nip">NIP Kepala Sekolah</label>
                    <input type="text" name="nip" id="nip" class="form-control" value="<?= $kepsek['nip'] ?>" readonly>
                    <?= form_error('nip', '<div class="text-danger small">', '</div>'); ?>
                  </div>
                  <div class="form-group">
                    <label for="nama_kepsek">Nama Kepala Sekolah</label>
                    <input type="text" name="nama_kepsek" id="nama_kepsek" value="<?= $kepsek['nama_kepsek'] ?>" class="form-control" placeholder="Masukkan nama">
                    <?= form_error('nama_kepsek', '<div class="text-danger small">', '</div>'); ?>
                  </div>
                  <div class="form-group">
                    <label for="jenis_kelamin">Jenis Kelamin</label>
                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-control">
                      <option value="Laki-Laki" <?php if ($kepsek['jenis_kelamin'] == 'Laki-Laki') {
                                                  echo "selected";
                                                } ?>>Laki-Laki</option>
                      <option value="Perempuan" <?php if ($kepsek['jenis_kelamin'] == 'Perempuan') {
                                                  echo "selected";
                                                } ?>>Perempuan</option>
                    </select>
                ...
                <div class="col-xl-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="jabatan" id="jabatan" value="<?= $kepsek['jabatan'] ?>" class="form-control" placeholder="Jabatan">
                  ...
                  <div class="form-group">
                    ...
                    <select name="akademik_id" id="akademik_id" class="form-control">
                      ...
                      <?php foreach ($akademik as $akm) : ?>
                        <option value="<?= $akm['id_akm']; ?>"<?php if($akm['id_akm'] == $kepsek['akademik_id']) { echo "selected"; } ?>><?= $akm['tahun_ak']; ?></option>
                      <?php endforeach; ?>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="no_hp" id="no_hp" value="<?= $kepsek['no_hp'] ?>" class="form-control" placeholder="Masukkan no hp">
