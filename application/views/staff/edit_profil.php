...
<div class="main-content" id="panel">
  ...
  <div class="container-fluid mt--6">
    <div class="row">
      <div class="col-xl-12">
        <a href="<?= site_url('staff/profil'); ?>" class="btn btn-outline-white mb-3 btn-lg"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
        ...
        <div class="card">
          <div class="card-body">
            <form action="<?= site_url('staff/edit_profil'); ?>" method="post" enctype="multipart/form-data">
              <div class="row">
                <div class="col-xl-6">
